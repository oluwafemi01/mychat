...
from homesite.views import index,register
    ...
    if request.method == "POST" :
        ...
        if form.is_valid():
            ...
            if not request.user.is_authenticated():
                ...
                return render (request, 'homesite/home.html',{"title":title,"error":errormsg})
            else:
                return redirect("/")
        else:
...
def register_view(request):
    ...
    if form.is_valid():
        ...
        title="Registaration page"
        errormsg = "Invalid input fields"
    return render (request, 'homesite/register.html',{"title":title,"error":errormsg})
